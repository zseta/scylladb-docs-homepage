...
| Heap<br/>Memory<br/>(MiB)         | Not applicable with ScyllaDB                                                                                                                     |
| Off<br/>Heap<br/>Memory<br/>(MiB) | Shows how much memory is used,<br/>by all tables, for Memtables ,<br/>Bloom filters, Indexes, and<br/>Compression Metadata                       |
