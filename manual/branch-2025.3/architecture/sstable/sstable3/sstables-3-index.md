...
The SSTables index file, together with the [SSTables summary file](https://docs.scylladb.com/manual/branch-2025.3/architecture/sstable/sstable3/sstables-3-summary.md) , provides a way to efficiently locate a partition with a specific key or some position within a partition in the [SSTables data file](https://docs.scylladb.com/manual/branch-2025.3/architecture/sstable/sstable3/sstables-3-data-file-format.md).
...
The first byte, kind, stores the serialised ordinal of the value from the `bound_kind` enum (see [SSTables 3.0 data file format](https://docs.scylladb.com/manual/branch-2025.3/architecture/sstable/sstable3/sstables-3-data-file-format.md)) for the enum definition).
