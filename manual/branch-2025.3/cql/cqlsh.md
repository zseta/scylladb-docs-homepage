...
If you want to display your current ScyllaDB version, refer to [Check your current version of ScyllaDB](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/admin.md#check-your-current-version-of-scylla).
...
See [a dedicated article](https://docs.scylladb.com/manual/branch-2025.3/cql/describe-schema.md) to learn more.
...
[Back](https://docs.scylladb.com/manual/branch-2025.3/getting-started/index.md)
