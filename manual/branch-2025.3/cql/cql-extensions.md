...
After [enabling object storage support](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/admin.md#admin-keyspace-storage-options), configure your endpoints by
following these [instructions](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/admin.md#object-storage-configuration).
...
- [Lightweight Transactions](https://docs.scylladb.com/manual/branch-2025.3/features/lwt.md)
- [How does ScyllaDB LWT Differ from Apache Cassandra?](https://docs.scylladb.com/manual/branch-2025.3/kb/lwt-differences.md)
...
For more details, see [the article on DESCRIBE SCHEMA](https://docs.scylladb.com/manual/branch-2025.3/cql/describe-schema.md).
