...
See [Enabling Experimental Features](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/admin.md#yaml-enabling-experimental-features) for details.
...
see [Counting all rows in a table is slow](https://docs.scylladb.com/manual/branch-2025.3/kb/count-all-rows.md) for instructions.
