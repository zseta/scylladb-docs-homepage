...
3. Once all the new nodes are decommissioned, add them again with the [correct procedure](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/procedures/cluster-management/add-node-to-cluster.md).
