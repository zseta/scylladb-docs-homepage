...
The recommended instance types are [i3en](#system-requirements-i3en-instances), [i4i](#system-requirements-i4i-instances), [i7i](#system-requirements-i7i-instances), and [i7ie](#system-requirements-i7ie-instances).
...
Recommended instances types are [z3-highmem-highlssd and z3-highmem-standardlssd](https://cloud.google.com/compute/docs/storage-optimized-machines#z3_machine_types),
[n1-highmem](https://cloud.google.com/compute/docs/general-purpose-machines#n1_machines), and [n2-highmem](https://cloud.google.com/compute/docs/general-purpose-machines#n2_machines).
