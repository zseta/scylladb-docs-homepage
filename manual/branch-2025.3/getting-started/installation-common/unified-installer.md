...
[ScyllaDB Web Installer](https://docs.scylladb.com/manual/branch-2025.3/getting-started/installation-common/scylla-web-installer.md)
...
See [OS Support](https://docs.scylladb.com/manual/branch-2025.3/getting-started/os-support.md) for information about supported Linux distributions and versions.
