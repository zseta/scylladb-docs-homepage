...
2. Configure the `rpc_dict_training_when` parameter.
   ...
   As a result, the [Raft leader](https://docs.scylladb.com/manual/branch-2025.3/architecture/raft.md) node will
...
See the *Inter-node settings* section in [Configuration Parameters](https://docs.scylladb.com/manual/branch-2025.3/reference/configuration-parameters.md)
