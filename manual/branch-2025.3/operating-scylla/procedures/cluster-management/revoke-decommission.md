...
Before adding the new node again to the cluster, we need to verify that the node was removed using the [nodetool status](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/nodetool-commands/status.md) command.
...
3. Follow the [Adding a New Node Into an Existing ScyllaDB Cluster](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/procedures/cluster-management/add-node-to-cluster.md) procedure to add the decommissioned node back into the cluster
<br/>
