...
To complete the process, you need to [change the snitch](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/procedures/config-change/switch-snitch.md), edit the
...
2. Run [full repair on the cluster](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/procedures/maintenance/repair.md)
