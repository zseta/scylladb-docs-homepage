...
When `rebuild` is enabled in [Repair Based Node Operations (RBNO)](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/procedures/cluster-management/repair-based-node-operation.md),
...
When [adding a new data-center into an existing ScyllaDB cluster](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/procedures/cluster-management/add-dc-to-existing-dc.md) use the rebuild command.
...
See [Data Distribution with Tablets](https://docs.scylladb.com/manual/branch-2025.3/architecture/tablets.md).
