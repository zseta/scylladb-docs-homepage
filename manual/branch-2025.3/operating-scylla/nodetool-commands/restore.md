...
You can configure the TTL duration using the [nodetool tasks user-ttl](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/nodetool-commands/tasks/user-ttl.md) command.
...
* **With the \`\`–nowait\`\` flag**: The command immediately returns a task ID without waiting for the operation to complete. You can use this task ID with the [nodetool tasks](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/nodetool-commands/tasks/index.md) command to monitor the progress of the restore operation or to cancel it if needed. The task information remains available for the duration specified by `user_task_ttl` after completion.
...
* `--endpoint` - Name of the configured object storage endpoint to load SSTables from.
  This should be configured as per [the object storage configuration instructions](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/admin.md#object-storage-configuration).
...
[Nodetool backup](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/nodetool-commands/backup.md)
