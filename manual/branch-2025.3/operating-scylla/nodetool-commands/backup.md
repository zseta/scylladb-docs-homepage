...
You can set the ttl using [nodetool tasks user-ttl](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/nodetool-commands/tasks/user-ttl.md).
...
[Nodetool restore](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/nodetool-commands/restore.md)
