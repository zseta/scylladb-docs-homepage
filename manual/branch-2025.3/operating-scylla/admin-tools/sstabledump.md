...
Please consider switching to [ScyllaDB SSTable](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/admin-tools/scylla-sstable.md).

This tool allows you to converts SSTable into a JSON format file.
If you need more flexibility or want to dump more than just the data-component, see [scylla-sstable](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/admin-tools/scylla-sstable.md).
