...
Enable ScyllaDB [Authentication](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/authentication.md) and [Authorization](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/enable-authorization.md).
...
| ADMIN       | Logs service level operations: create, alter, drop, attach, detach, list.<br/>For [service level](https://docs.scylladb.com/manual/branch-2025.3/features/workload-prioritization.md#workload-priorization-service-level-management)<br/>auditing. |
...
By default, audit messages are written to the same destination as Scylla [logging](https://docs.scylladb.com/manual/branch-2025.3/getting-started/logging.md), with `scylla-audit` as the process name.
...
* [Authentication](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/authentication.md)
