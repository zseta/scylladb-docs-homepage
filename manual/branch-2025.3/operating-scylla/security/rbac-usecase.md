...
In addition to standard roles, ScyllaDB users can implement [Workload Prioritization](https://docs.scylladb.com/manual/branch-2025.3/features/workload-prioritization.md), which allows you to attach roles to Service Levels, thus granting resources to roles as the role demands.
...
In this case, four roles would be created: staff, customer, trainer, and administrator. Permissions could be any of the [following](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/authorization.md#data-control).
...
You need to login to cqlsh as a user with authentication and authorization. You **must** enable [authentication](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/authentication.md) **and** [authorization](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/enable-authorization.md) if you have not already done so. In addition, the user you create for yourself **must** have login privileges, a user name, and a password.
...
* [Authorization](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/authorization.md)
* [CQLSh the CQL shell](https://docs.scylladb.com/manual/branch-2025.3/cql/cqlsh.md)
* [Workload Prioritization](https://docs.scylladb.com/manual/branch-2025.3/features/workload-prioritization.md) - to attach a service level to a role
