...
The following assumes that Authentication has already been enabled via the process outlined in [Enable Authentication](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/authentication.md). Perform these steps to enable internal authorization across the cluster:
...
See [Creating a Custom Superuser](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/create-superuser.md) for instructions.
...
**Before you Begin**
Validate you have set the authenticator as described in [Authentication](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/authentication.md).
...
1. Configure the appropriate access privileges for clients using [GRANT PERMISSION](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/authorization.md#grant-permission-statement) statements.  For additional examples, consult the [RBAC example](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/rbac-usecase.md).
...
* Clients are not able to connect until you setup roles as users with passwords  using [GRANT PERMISSION](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/authorization.md#grant-permission-statement) statements (using the superuser). Refer to the example in [Role Based Access Control (RBAC)](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/rbac-usecase.md) for details.
...
1. To remove permission from any role or user, see [REVOKE PERMISSION](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/authorization.md#revoke-permission-statement).
...
* [Role Based Access Control (RBAC)](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/rbac-usecase.md)
* [Authorization](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/authorization.md) - CQL Reference for authorizing users
* [Authentication](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/authentication.md) - Enable Authentication
