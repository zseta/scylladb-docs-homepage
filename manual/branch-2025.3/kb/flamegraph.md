...
1. Install flamegraph and flamegraph-stackcollapse-perf
   ...
   cd FlameGraph
   ```
2. Run the following perf commands, using [Map CPU to ScyllaDB Shards](https://docs.scylladb.com/manual/branch-2025.3/kb/map-cpu.md)  and [Using the perf utility with ScyllaDB](https://docs.scylladb.com/manual/branch-2025.3/kb/use-perf.md) for reference.
   ```shell
