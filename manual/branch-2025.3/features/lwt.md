...
#### NOTE
The LWT feature is not supported in keyspaces with [tablets](https://docs.scylladb.com/manual/branch-2025.3/architecture/tablets.md) enabled.
...
* [How to Change gc_grace_seconds for a Table](https://docs.scylladb.com/manual/branch-2025.3/kb/gc-grace-seconds.md) - How to change the `gc_grace_seconds` parameter for a table
