...
* An [authenticated](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/runtime-authentication.md) and [authorized](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/enable-authorization.md) user
* At least one [role created](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/authorization.md#create-role-statement).
...
When you create a service level, you allocate a percentage of resources to the service level. Remember to use the correct naming convention to name your service level. If you decide to use [reserved keywords](https://docs.scylladb.com/manual/branch-2025.3/cql/appendices.md#appendix-a), enclose them in either single or double quotes (for example `'primary'`).
...
#### WARNING
Altering the SERVICE LEVEL does not affect active sessions (see [#12923](https://github.com/scylladb/scylladb/issues/12923)).

To apply a new timeout to existing clients, execute a [rolling restart](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/procedures/config-change/rolling-restart.md) after the ALTER command.
...
* `service_level_name` - Specifies the name of the service level you created. See [Create a Service Level]().
* `role_name` - Specifies the role that you want to use the service level on. This is the role you created with [create role](https://docs.scylladb.com/manual/branch-2025.3/operating-scylla/security/authorization.md#create-role-statement).
