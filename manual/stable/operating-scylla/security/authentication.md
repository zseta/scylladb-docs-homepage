...
3. Start cqlsh over the maintenance socket and create a new superuser. See [Setting Up a Superuser Using the Maintenance Socket](https://docs.scylladb.com/manual/stable/operating-scylla/security/create-superuser.md#create-superuser-using-maintenance-socket) for instructions.
   > ```cql
   > cqlsh <maintenance_socket_path>
   > ```
4. If you want to create users and roles, continue to [Enable Authorization](https://docs.scylladb.com/manual/stable/operating-scylla/security/enable-authorization.md).
...
* [LDAP Authentication](https://docs.scylladb.com/manual/stable/operating-scylla/security/ldap-authentication.md)
