...
The only way to make CQL queries is to use [the maintenance socket](https://docs.scylladb.com/manual/stable/operating-scylla/admin-tools/maintenance-socket.md). The node serves only local data.
