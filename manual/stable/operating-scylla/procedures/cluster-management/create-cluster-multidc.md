...
* Make sure that all the [ports](https://docs.scylladb.com/manual/stable/operating-scylla/admin.md#cqlsh-networking) are open.
...
* [Ec2multiregionsnitch](https://docs.scylladb.com/manual/stable/operating-scylla/system-configuration/snitch.md#snitch-ec2-multi-region-snitch) - for AWS cloud-based, multi-data-center deployments.
* [GossipingPropertyFileSnitch](https://docs.scylladb.com/manual/stable/operating-scylla/system-configuration/snitch.md#snitch-gossiping-property-file-snitch) - for bare metal and cloud (other than AWS) deployments.

### Procedure

1. Install ScyllaDB on the nodes you want to add to the cluster. See [Getting Started](https://docs.scylladb.com/manual/stable/getting-started/index.md) for further instructions, create as many nodes that you need.
Follow the ScyllaDB install procedure up to scylla.yaml configuration phase.

In case that your node starts during the process follow [these instructions](https://docs.scylladb.com/manual/stable/operating-scylla/procedures/cluster-management/clear-data.md)
...
See [Preventing Quorum Loss in Symmetrical Multi-DC Clusters](https://docs.scylladb.com/manual/stable/operating-scylla/procedures/cluster-management/arbiter-dc.md)
for details.
