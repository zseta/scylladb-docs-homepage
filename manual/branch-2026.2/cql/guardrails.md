...
liveness information, see [Configuration Parameters](https://docs.scylladb.com/manual/branch-2026.2/reference/configuration-parameters.md).
...
`SimpleStrategy`, see [Update Topology Strategy From Simple to Network](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/procedures/cluster-management/update-topology-strategy-from-simple-to-network.md)
...
[Compact Tables](https://docs.scylladb.com/manual/branch-2026.2/cql/ddl.md#compact-tables) in the Data Definition documentation.

## Additional References

* [Consistency Level](https://docs.scylladb.com/manual/branch-2026.2/cql/consistency.md)
* [Data Definition (CREATE/ALTER KEYSPACE)](https://docs.scylladb.com/manual/branch-2026.2/cql/ddl.md)
* [How to Safely Increase the Replication Factor](https://docs.scylladb.com/manual/branch-2026.2/kb/rf-increase.md)
* [Metrics Reference](https://docs.scylladb.com/manual/branch-2026.2/reference/metrics.md)
