...
For more context, see the articles covering [backing up](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/procedures/backup-restore/backup.md)
and [restoring](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/procedures/backup-restore/restore.md) the schema.
...
See [the article on authorization in ScyllaDB](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/security/authorization.md) to learn more about it.
