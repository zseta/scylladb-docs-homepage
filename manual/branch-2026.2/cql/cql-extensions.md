...
- [Lightweight Transactions](https://docs.scylladb.com/manual/branch-2026.2/features/lwt.md)
- [How does ScyllaDB LWT Differ from Apache Cassandra?](https://docs.scylladb.com/manual/branch-2026.2/kb/lwt-differences.md)
...
For more details, see [the article on DESCRIBE SCHEMA](https://docs.scylladb.com/manual/branch-2026.2/cql/describe-schema.md).
