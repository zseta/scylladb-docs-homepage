...
Refer to [LWT](https://docs.scylladb.com/manual/branch-2026.2/features/lwt.md) for more information.

The `gc_grace_seconds` parameter is defined [here](https://docs.scylladb.com/manual/branch-2026.2/cql/ddl.md#create-table-general-options).

## TTL for a Collection

You can set the TTL on a per element basis for collections.

See for example the [Maps](https://docs.scylladb.com/manual/branch-2026.2/cql/types.md#maps) CQL Reference for map collections.
...
See the [WRITETIME and TTL function](https://docs.scylladb.com/manual/branch-2026.2/cql/dml/select.md#select-writetime-ttl) section for details.
...
* [Video: Managing data expiration with Time-To-Live](https://www.youtube.com/watch?v=SXkbu7mFHeA)
* [Apache Cassandra Query Language (CQL) Reference](https://docs.scylladb.com/manual/branch-2026.2/cql/index.md)
* [KB Article:How to Change gc_grace_seconds for a Table](https://docs.scylladb.com/manual/branch-2026.2/kb/gc-grace-seconds.md)
* [KB Article:Time to Live (TTL) and Compaction](https://docs.scylladb.com/manual/branch-2026.2/kb/ttl-facts.md)
* [CQL Reference: Table Options](https://docs.scylladb.com/manual/branch-2026.2/cql/ddl.md#create-table-general-options)
