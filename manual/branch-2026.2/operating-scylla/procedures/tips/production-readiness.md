...
* [ScyllaDB System Requirements](https://docs.scylladb.com/manual/branch-2026.2/getting-started/system-requirements.md) - verify your instances, system, OS, etc are supported by ScyllaDB for production machines.
* [ScyllaDB Getting Started](https://docs.scylladb.com/manual/branch-2026.2/getting-started/index.md)

### Choose a Compaction Strategy

Each workload may require a specific strategy. Refer to [Choose a Compaction Strategy](https://docs.scylladb.com/manual/branch-2026.2/architecture/compaction/compaction-strategies.md) for details.
...
* Refer to [Incremental Compaction Strategy](https://docs.scylladb.com/manual/branch-2026.2/architecture/compaction/compaction-strategies.md#ics1) for an overview of the benefits.
* Refer to [Incremental Compaction Strategy Overview](https://docs.scylladb.com/manual/branch-2026.2/kb/compaction.md#incremental-compaction-strategy-ics) for a description of how it works.
...
Verify the [Replication Factor](https://docs.scylladb.com/manual/branch-2026.2/reference/glossary.md#term-Replication-Factor-RF) is set properly **for each keyspace**.
...
* Read more about [ScyllaDB Fault Tolerance](https://docs.scylladb.com/manual/branch-2026.2/architecture/architecture-fault-tolerance.md)
...
Verify the [Consistency Level (CL)](https://docs.scylladb.com/manual/branch-2026.2/reference/glossary.md#term-Consistency-Level-CL) is set properly **for each table**.

We recommend using `LOCAL_QUORUM` across **the cluster and DCs**

For additional information:

* Refer to [ScyllaDB Fault Tolerance](https://docs.scylladb.com/manual/branch-2026.2/architecture/architecture-fault-tolerance.md)
* Watch a [Demo](https://docs.scylladb.com/manual/branch-2026.2/architecture/console-CL-full-demo.md)
...
1. Choose the correct Snitch.
   ...
   **Do Not** use SimpleStrategy on any production machine, even if you only have a single DC.
   ...
   For additional information:
   * Refer to [Gossip in ScyllaDB](https://docs.scylladb.com/manual/branch-2026.2/kb/gossip.md)
   * Follow the [How to Switch Snitches](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/procedures/config-change/switch-snitch.md) procedure if required.
...
For additional information, see the Admin Guide [Inter-node Compression](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/admin.md#internode-compression) section.
...
* Enable [Authentication](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/security/authentication.md)
* Create Roles for all users and use [RBAC](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/security/rbac-usecase.md) with or without LDAP (coming soon).
* Use Encryption in Transit [between nodes](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/security/node-node-encryption.md) and [client to node](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/security/client-node-encryption.md).
* Refer to the [Security Checklist](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/security/security-checklist.md) for more information.
...
* [Add a Node](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/procedures/cluster-management/add-node-to-cluster.md)
* [Repair](https://manager.docs.scylladb.com/branch-2.2/repair/index.html)
* [Cleanup](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/nodetool-commands/cleanup.md)
