...
But, if `scylla_setup` has not run, the system won’t be configured optimally. Refer to the [System Configuration](https://docs.scylladb.com/manual/branch-2026.2/getting-started/system-configuration.md) guide for details.
...
Tools, such as [cassandra-stress](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/admin-tools/cassandra-stress.md), use a default data model that does not reflect the actions that you will perform in production.
...
* [Large partitions](https://docs.scylladb.com/manual/branch-2026.2/troubleshooting/large-partition-table.md), [large rows and large cells](https://docs.scylladb.com/manual/branch-2026.2/troubleshooting/large-rows-large-cells-tables.md) should be avoided because it can cause high latencies.
...
See [Workload prioritization](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/security/encryption-at-rest.md).
...
See [Bypass Cache](https://docs.scylladb.com/manual/branch-2026.2/cql/dml/select.md#bypass-cache) for more information.
...
Without [batching](https://docs.scylladb.com/manual/branch-2026.2/cql/dml/batch.md#batch-statement) the total latency would be 10x(0.9+0.1)=10.0 ms.
...
Read more about [ScyllaDB System Requirements](https://docs.scylladb.com/manual/branch-2026.2/getting-started/system-requirements.md).
...
Read more about  [ScyllaDB System Requirements](https://docs.scylladb.com/manual/branch-2026.2/getting-started/system-requirements.md) or [Starting ScyllaDB in a Shared Environment](https://docs.scylladb.com/manual/branch-2026.2/getting-started/scylla-in-a-shared-environment.md).
...
Read more about [ScyllaDB Network Requirements](https://docs.scylladb.com/manual/branch-2026.2/getting-started/system-requirements.md#system-requirements-network).
...
Read more about [Starting ScyllaDB in a Shared Environment](https://docs.scylladb.com/manual/branch-2026.2/getting-started/scylla-in-a-shared-environment.md).
...
Read more about [ScyllaDB Supported Platforms](https://docs.scylladb.com/manual/branch-2026.2/getting-started/system-requirements.md#system-requirements-supported-platforms).
...
Read more about [Azure Requirements](https://docs.scylladb.com/manual/branch-2026.2/getting-started/cloud-instance-recommendations.md#system-requirements-azure).
...
* Use the following [Compaction Strategy Matrix](https://docs.scylladb.com/manual/branch-2026.2/architecture/compaction/compaction-strategies.md#csm1) to use the correct compaction strategy for your workload.
...
Read more about [Compaction Strategies](https://docs.scylladb.com/manual/branch-2026.2/architecture/compaction/compaction-strategies.md)
...
Read more about [Fault Tolerance](https://docs.scylladb.com/manual/branch-2026.2/architecture/architecture-fault-tolerance.md)
