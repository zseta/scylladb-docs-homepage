...
See [Nodetool tasks](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/nodetool-commands/tasks/index.md).

To learn how to interact with REST API see [REST API](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/rest.md).
