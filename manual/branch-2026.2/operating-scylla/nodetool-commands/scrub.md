...
**Step 3**: Drop the quarantined SSTables using [dropquarantinedsstables](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/nodetool-commands/dropquarantinedsstables.md):
