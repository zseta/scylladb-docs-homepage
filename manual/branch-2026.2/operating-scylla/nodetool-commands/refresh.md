...
[Materialized Views (MV)](https://docs.scylladb.com/manual/branch-2026.2/cql/mv.md) and [Secondary Indexes (SI)](https://docs.scylladb.com/manual/branch-2026.2/cql/secondary-indexes.md) of the upload table, and if they exist, they are automatically updated. Uploading MV or SI SSTables is not required and will fail.
...
See [nodetool cleanup](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/nodetool-commands/cleanup.md#nodetool-cleanup-cmd).
