...
Scylla customers can manage and authorize users’ privileges via an  server.
...
#### NOTE
Usernames substituted into `{USER}` are automatically escaped
...
Each role must already exist in Scylla, created via the [CREATE ROLE](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/security/authorization.md#create-role-statement) CQL command beforehand.
