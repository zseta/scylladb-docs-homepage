...
of nodes in that datacenter. Alternatively, you can use `EverywhereReplicationStrategy`. See [How to Safely Increase the Replication Factor](https://docs.scylladb.com/manual/branch-2026.2/kb/rf-increase.md) for details on changing the RF.
...
If you are sending this data to ScyllaDB for help, follow the directions in [How to Report a ScyllaDB Problem](https://docs.scylladb.com/manual/branch-2026.2/troubleshooting/report-scylla-problem.md#report-performance-problem).
