...
[ScyllaDB Alternator for DynamoDB users](https://docs.scylladb.com/manual/branch-2026.2/alternator/compatibility.md) document.
...
As explained in [ScyllaDB Alternator for DynamoDB users](https://docs.scylladb.com/manual/branch-2026.2/alternator/compatibility.md),
...
[Data Distribution with Tablets](https://docs.scylladb.com/manual/branch-2026.2/architecture/tablets.md) for details.
...
[tablets_mode_for_new_keyspaces](https://docs.scylladb.com/manual/branch-2026.2/reference/configuration-parameters.md#confval-tablets_mode_for_new_keyspaces)
tells them to.
