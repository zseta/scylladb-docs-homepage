...
See [Preventing Quorum Loss in Symmetrical Multi-DC Clusters](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/procedures/cluster-management/arbiter-dc.md) for details.
...
* Racks consisting solely of zero-token nodes are not taken into consideration
  when deciding whether a keyspace is [RF-rack-valid](https://docs.scylladb.com/manual/branch-2026.2/reference/glossary.md#term-RF-rack-valid-keyspace).
  However, an RF-rack-valid keyspace must have the replication factor equal to 0
  in an [arbiter DC](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/procedures/cluster-management/arbiter-dc.md).
