...
ScyllaDB implements the following compaction strategies in order to reduce [read amplification](https://docs.scylladb.com/manual/branch-2026.2/reference/glossary.md#term-Read-Amplification), [write amplification](https://docs.scylladb.com/manual/branch-2026.2/reference/glossary.md#term-Write-Amplification), and [space amplification](https://docs.scylladb.com/manual/branch-2026.2/reference/glossary.md#term-Space-amplification), which causes bottlenecks and poor performance. These strategies include:
...
The premise of [Size-tiered Compaction Strategy (STCS)](https://docs.scylladb.com/manual/branch-2026.2/reference/glossary.md#term-Size-tiered-compaction-strategy) is to merge SSTables of approximately the same size.
...
Set the parameters for [Size-tiered compaction](https://docs.scylladb.com/manual/branch-2026.2/kb/compaction.md#size-tiered-compaction-strategy-stcs).

<a id="lcs1"></a>

## Leveled Compaction Strategy (LCS)

[Leveled Compaction Strategy](https://docs.scylladb.com/manual/branch-2026.2/reference/glossary.md#term-Leveled-compaction-strategy-LCS) (LCS) uses small, fixed-size (by default 160 MB) SSTables divided into different levels. Each level represents a run of a number of SSTables.
...
Set the parameters for [Leveled Compaction](https://docs.scylladb.com/manual/branch-2026.2/kb/compaction.md#leveled-compaction-strategy-lcs).
...
Set the parameters for [Incremental Compaction](https://docs.scylladb.com/manual/branch-2026.2/kb/compaction.md#incremental-compaction-strategy-ics).

For more information, see the [Compaction KB Article](https://docs.scylladb.com/manual/branch-2026.2/kb/compaction.md#incremental-compaction-strategy-ics).
...
SSTables from different time windows are never compacted together. You set the [TimeWindowCompactionStrategy](https://docs.scylladb.com/manual/branch-2026.2/kb/compaction.md#time-window-compactionstrategy-twcs) parameters when you create a table using a CQL command.
...
Set the parameters for [Time-window Compaction](https://docs.scylladb.com/manual/branch-2026.2/kb/compaction.md#time-window-compactionstrategy-twcs).
...
* [Compaction Overview](https://docs.scylladb.com/manual/branch-2026.2/kb/compaction.md) - contains in depth information on all of the strategies
* [Compaction CQL Reference](https://docs.scylladb.com/manual/branch-2026.2/cql/compaction.md) - covers the CQL parameters used for implementing compaction
