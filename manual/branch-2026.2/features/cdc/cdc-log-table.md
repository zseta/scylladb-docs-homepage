...
2. then consult the [Basic operations in CDC](https://docs.scylladb.com/manual/branch-2026.2/features/cdc/cdc-basic-operations.md) document to understand how basic modification statements, such as single UPDATEs or DELETEs, which don’t involve collections, are reflected in CDC using delta rows.
...
Values 1-8 are for delta rows. Read about the different operations in the [Basic operations in CDC](https://docs.scylladb.com/manual/branch-2026.2/features/cdc/cdc-basic-operations.md) document.
