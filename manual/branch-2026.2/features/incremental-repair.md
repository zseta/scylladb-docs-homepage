...
Tables using Incremental Repair can schedule repairs in ScyllaDB itself, with [Automatic Repair](https://docs.scylladb.com/manual/branch-2026.2/features/automatic-repair.md).
