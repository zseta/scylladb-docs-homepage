...
using the [ALTER KEYSPACE](https://docs.scylladb.com/manual/branch-2026.2/cql/ddl.md#alter-keyspace-statement) command.
...
(the default) or has tablets disabled. See [Data Distribution with Tablets](https://docs.scylladb.com/manual/branch-2026.2/architecture/tablets.md)
...
If you [opted out of tablets when creating a keyspace](https://docs.scylladb.com/manual/branch-2026.2/architecture/tablets.md#tablets-enable-tablets),
...
* [Set the RF (first time)](https://docs.scylladb.com/manual/branch-2026.2/cql/ddl.md#create-keyspace-statement)
* [Change the RF (increase or decrease)](https://docs.scylladb.com/manual/branch-2026.2/cql/ddl.md#alter-keyspace-statement)
