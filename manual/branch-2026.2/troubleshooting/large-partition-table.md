...
Partitions that are bigger than the size threshold and/or hold more than the rows count threshold are reported in the `system.large_partitions` table and generate a warning in the ScyllaDB log (refer to [log](https://docs.scylladb.com/manual/branch-2026.2/getting-started/logging.md)).
...
<a id="large-data-virtual-tables"></a>
...
[Large Partitions Hunting](https://docs.scylladb.com/manual/branch-2026.2/troubleshooting/debugging-large-partition.md)
