...
To check if the maintenance socket is enabled, see [Admin Tools: Maintenance Socket](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/admin-tools/maintenance-socket.md) for details.
...
1. Edit `/etc/scylla/scylla.yaml` file and configure the maintenance socket.
   See [Admin Tools: Maintenance Socket](https://docs.scylladb.com/manual/branch-2026.2/operating-scylla/admin-tools/maintenance-socket.md) for details.
