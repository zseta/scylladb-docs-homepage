...
[Alternator-specific APIs](https://docs.scylladb.com/manual/branch-2025.2/alternator/new-apis.md). One of the options, `always_use_lwt`,
...
See [Workload Prioritization](https://docs.scylladb.com/manual/branch-2025.2/features/workload-prioritization.md)
...
See [Enabling Experimental Features](https://docs.scylladb.com/manual/branch-2025.2/operating-scylla/admin.md#enabling-experimental-features) for details.
