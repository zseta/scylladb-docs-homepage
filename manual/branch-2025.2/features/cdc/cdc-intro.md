...
* **Log Table** - this is the table associated to the base table which is created when CDC is enabled. Read about it in the [log table document](https://docs.scylladb.com/manual/branch-2025.2/features/cdc/cdc-log-table.md).
