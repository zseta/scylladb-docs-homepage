...
the `sq_split` mode instead of the `mq` mode (see [Seastar Perftune](https://docs.scylladb.com/manual/branch-2025.2/operating-scylla/admin-tools/perftune.md) for information about the modes).
