...
specify a Consistency Level per query is known as [Tunable Consistency](https://docs.scylladb.com/manual/branch-2025.2/reference/glossary.md#term-Tunable-Consistency).
...
A related feature is [Lightweight Transactions (LWT)](https://docs.scylladb.com/manual/branch-2025.2/features/lwt.md). LWT in ScyllaDB allow the client
...
* [Consistency Levels documentation](https://docs.scylladb.com/manual/stable/cql/consistency.html)
