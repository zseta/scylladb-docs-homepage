...
ScyllaDB introduces JSON support to [SELECT](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/select.md#select-statement) and [INSERT](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/insert.md#insert-statement)
...
| `timestamp` | integer, string        | string          | A timestamp. Strings constant allows to input [timestamps<br/>as dates](https://docs.scylladb.com/manual/branch-2025.2/cql/types.md#timestamps). Datestamps with format `YYYY-MM-DD<br/>HH:MM:SS.SSS` are returned. |
