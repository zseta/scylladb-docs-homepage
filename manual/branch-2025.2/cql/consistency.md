...
|--------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|---------------------------------------|
| ANY (Write Only)         | Closest replica, as determined by the snitch. If all replica nodes are down, write succeeds after a [hinted handoff](https://docs.scylladb.com/manual/branch-2025.2/reference/glossary.md#term-Hinted-Handoff). Provides low latency, guarantees writes never fail. | Lowest (WRITE)                | Highest (WRITE)                       |
| ONE                      | The closest replica as determined by the [Snitch](https://docs.scylladb.com/manual/branch-2025.2/reference/glossary.md#term-Snitch). Consistency requirements are not too strict.                                                                                   | Lowest (READ)                 | Highest (READ)                        |
...
* [Consistency Level Calculator](https://docs.scylladb.com/manual/branch-2025.2/cql/consistency-calculator.md)
* [Fault Tolerance](https://docs.scylladb.com/manual/branch-2025.2/architecture/architecture-fault-tolerance.md)
* [Consistency Level Compatibility](https://docs.scylladb.com/manual/branch-2025.2/using-scylla/cassandra-compatibility.md#consistency-level-read-and-write)
* [Consistency Quiz](https://docs.scylladb.com/manual/branch-2025.2/kb/quiz-administrators.md)
