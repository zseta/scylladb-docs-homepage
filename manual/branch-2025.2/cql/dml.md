...
* [SELECT](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/select.md)
* [INSERT](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/insert.md)
* [UPDATE](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/update.md)
* [DELETE](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/delete.md)
* [BATCH](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/batch.md)
...
- `TIMESTAMP`: sets the timestamp for the operation. If not specified, the coordinator will use the current time, in
  *microseconds* since the [Unix epoch](https://en.wikipedia.org/wiki/Unix_time) (January 1st 1970 at 00:00:00 UTC),
  ...
  [INSERT](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/insert.md#insert-statement), [UPDATE](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/update.md#update-statement), [DELETE](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/delete.md#delete-statement), or [BATCH](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/batch.md#batch-statement)
...
- `TTL`: specifies an optional Time To Live (in seconds) for the inserted values. If set, the inserted values are
  ...
  to inserting with a TTL of 0. You can read more about TTL in the [documentation](https://docs.scylladb.com/manual/branch-2025.2/cql/time-to-live.md) and also in [this ScyllaDB University lesson](https://university.scylladb.com/courses/data-modeling/lessons/advanced-data-modeling/topic/expiring-data-with-ttl-time-to-live/).
- `TIMEOUT`: specifies a timeout duration for the specific request.
  Please refer to the [SELECT](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/select.md#using-timeout) section for more information.

<a id="update-ordering"></a>

## Update ordering

[INSERT](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/insert.md#insert-statement), [UPDATE](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/update.md#update-statement), and [DELETE](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/delete.md#delete-statement)
...
and by using [Lightweight Transactions (LWT)](https://docs.scylladb.com/manual/branch-2025.2/features/lwt.md) to ensure atomicity of
[INSERT](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/insert.md#insert-statement), [UPDATE](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/update.md#update-statement), and [DELETE](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/delete.md#delete-statement).
