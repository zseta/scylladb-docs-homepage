...
See [Handling Node Failures](https://docs.scylladb.com/manual/branch-2025.2/troubleshooting/handling-node-failures.md) for details.
...
In all cases, for creating keyspaces and tables, if you are using [Reserved Keywords](https://docs.scylladb.com/manual/branch-2025.2/cql/reserved-keywords.md), enclose them in single or double-quotes.
...
with tablets enabled. Keyspaces using tablets must also remain [RF-rack-valid](https://docs.scylladb.com/manual/branch-2025.2/reference/glossary.md#term-RF-rack-valid-keyspace)
throughout their lifetime. See [Limitations and Unsupported Features](https://docs.scylladb.com/manual/branch-2025.2/architecture/tablets.md#tablets-limitations)
for details.
...
See [Data Distribution with Tablets](https://docs.scylladb.com/manual/branch-2025.2/architecture/tablets.md) for more information about tablets.
...
See [Keyspace storage options](https://docs.scylladb.com/manual/branch-2025.2/operating-scylla/admin.md#admin-keyspace-storage-options) for details.
...
- The `ALTER` statement will fail if it would make the keyspace [RF-rack-invalid](https://docs.scylladb.com/manual/branch-2025.2/reference/glossary.md#term-RF-rack-valid-keyspace).
...
Refer to [this article](https://docs.scylladb.com/manual/branch-2025.2/troubleshooting/drop-table-space-up.md) or this [FAQ entry](https://docs.scylladb.com/manual/branch-2025.2/faq.md#reclaim-space).
...
A `column_definition` is primarily comprised of the name of the column defined and its [type](https://docs.scylladb.com/manual/branch-2025.2/cql/types.md#id1),
...
- it limits which `ORDER BY` clause is allowed for [selects](https://docs.scylladb.com/manual/branch-2025.2/cql/dml/select.md#select-statement) on that table. You can only
...
Custom strategy can be provided by specifying the full class name as a [string constant](https://docs.scylladb.com/manual/branch-2025.2/cql/definitions.md#constants).

All default strategies support a number of common options, as well as options specific to
the strategy chosen (see the section corresponding to your strategy for details: [STCS](https://docs.scylladb.com/manual/branch-2025.2/cql/compaction.md#stcs-options), [LCS](https://docs.scylladb.com/manual/branch-2025.2/cql/compaction.md#lcs-options), [ICS](https://docs.scylladb.com/manual/branch-2025.2/cql/compaction.md#ics-options), and [TWCS](https://docs.scylladb.com/manual/branch-2025.2/cql/compaction.md#twcs-options)).
...
(in seconds) before data marked with a deletion [tombstone](https://docs.scylladb.com/manual/branch-2025.2/reference/glossary.md#term-Tombstone) is removed via compaction.
This option assumes that you run [repair](https://docs.scylladb.com/manual/branch-2025.2/reference/glossary.md#term-Repair) during the specified time. Failing to run repair during the wait
time may result in the resurrection of deleted data.

The `tombstone_gc` option allows you to prevent data resurrection. With the `repair` mode configured, [tombstone](https://docs.scylladb.com/manual/branch-2025.2/reference/glossary.md#term-Tombstone)
are only removed after [repair](https://docs.scylladb.com/manual/branch-2025.2/reference/glossary.md#term-Repair) is performed. Unlike  `gc_grace_seconds`, `tombstone_gc` has no time constraints - when
...
The purpose of this statement is to be able to safely restore schema (see [Backup and Restore Procedures](https://docs.scylladb.com/manual/branch-2025.2/operating-scylla/procedures/backup-restore/index.md)) in the case a column was dropped and re-added later.
...
#### NOTE
Dropping a table that has materialized views is disallowed and will return an error. To do so, the materialized views that depend on the table must first be explicitly dropped. Refer to [Materialized Views](https://docs.scylladb.com/manual/branch-2025.2/cql/mv.md) for details.
...
* [Apache Cassandra Query Language (CQL) Reference](https://docs.scylladb.com/manual/branch-2025.2/cql/index.md)
