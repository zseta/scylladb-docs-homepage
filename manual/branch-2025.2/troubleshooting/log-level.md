...
Alternatively, you can use Nodetool commands. Refer to [setlogginglevel](https://docs.scylladb.com/manual/branch-2025.2/operating-scylla/nodetool-commands/setlogginglevel.md) to set the logging level threshold for ScyllaDB classes.
...
[Nodetool setlogginglevel](https://docs.scylladb.com/manual/branch-2025.2/operating-scylla/nodetool-commands/setlogginglevel.md)
