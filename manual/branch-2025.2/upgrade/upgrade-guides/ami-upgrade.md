...
instructions on the **Debian/Ubuntu** tab in the [upgrade guide](https://docs.scylladb.com/manual/branch-2025.2/upgrade/index.md)
...
in the [upgrade guide](https://docs.scylladb.com/manual/branch-2025.2/upgrade/index.md) for your ScyllaDB version.
