# Upgrade - ScyllaDB 2025.2.x.y to 2025.2.x.z (Patch Upgrades)

This document describes a step-by-step procedure for upgrading from
ScyllaDB 2025.2.x.y  to ScyllaDB 2025.2.x.z (where “z” is
the latest available version), and rolling back to version 2025.2.x.y
if necessary.

This guide covers upgrading ScyllaDB on Red Hat Enterprise Linux (RHEL),
CentOS, Debian, and Ubuntu.
See [OS Support by Platform and Version](https://docs.scylladb.com/manual/branch-2025.2/getting-started/os-support.md)
...
* Not to use new 2025.2.x.z features.
...
2025.2.x.z to 2025.2.x.y. Apply this procedure if an upgrade from
2025.2.x.y to 2025.2.x.z failed before completing on all nodes.

* Use this procedure only on nodes you upgraded to 2025.2.x.z.
...
cluster shutdown. For each of the nodes to roll back to 2025.2.x.y, you will:
...
To downgrade to 2025.2.x.y on Debian or Ubuntu, run:

```console
sudo apt-get install scylla=2025.2.x.y\* scylla-server=2025.2.x.y\* scylla-tools=2025.2.x.y\* scylla-tools-core=2025.2.x.y\* scylla-kernel-conf=2025.2.x.y\* scylla-conf=2025.2.x.y\*
```
...
To downgrade to 2025.2.x.y on RHEL or CentOS, run:

```console
sudo yum downgrade scylla\*-2025.2.x.y-\* -y
```
...
```console
sudo apt-get install scylla=2025.2.x.y\* scylla-server=2025.2.x.y\* scylla-tools=2025.2.x.y\* scylla-tools-core=2025.2.x.y\* scylla-kernel-conf=2025.2.x.y\* scylla-conf=2025.2.x.y\*
sudo apt-get install scylla-machine-image=2025.2.x.y\*
```
