...
To build a self-signed certificate chain, see [generating a self-signed certificate chain using openssl](https://docs.scylladb.com/manual/branch-2025.2/operating-scylla/security/generate-certificate.md).
...
* [Invalid SSL Protocol Error](https://docs.scylladb.com/manual/branch-2025.2/troubleshooting/error-messages/invalid-ssl-prot-error.md)
