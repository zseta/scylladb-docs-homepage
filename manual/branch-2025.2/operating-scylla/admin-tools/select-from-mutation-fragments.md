...
So far this was only possible with sstables, using a tool like [ScyllaDB SStable](https://docs.scylladb.com/manual/branch-2025.2/operating-scylla/admin-tools/scylla-sstable.md).
...
This is uses the same JSON schema as [scylla sstable dump-data](https://docs.scylladb.com/manual/branch-2025.2/operating-scylla/admin-tools/scylla-sstable.md#scylla-sstable-dump-data-operation).
...
JSON symbols are represented as `$SYMBOL_NAME`, the definition of these can be found in [scylla sstable dump-data](https://docs.scylladb.com/manual/branch-2025.2/operating-scylla/admin-tools/scylla-sstable.md#scylla-sstable-dump-data-operation).
...
See [scylla sstable dump-data](https://docs.scylladb.com/manual/branch-2025.2/operating-scylla/admin-tools/scylla-sstable.md#scylla-sstable-dump-data-operation) for the definition of these.
