...
It is not always clear under which circumstances data is deleted when using Time to Live (TTL) and [gc_grace_seconds](https://docs.scylladb.com/manual/branch-2025.4/cql/ddl.md#gc-grace-seconds) arguments in table definitions.
...
* [How to Change gc_grace_seconds for a Table](https://docs.scylladb.com/manual/branch-2025.4/kb/gc-grace-seconds.md)
* [Expiring Data with Time to Live (TTL)](https://docs.scylladb.com/manual/branch-2025.4/cql/time-to-live.md)
