...
If you need text result of this query as a single run, without the page delimiter, you can [turn off paging](https://docs.scylladb.com/manual/branch-2025.4/cql/cqlsh.md#cqlsh-paging).
