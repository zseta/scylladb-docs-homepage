...
- [Lightweight Transactions](https://docs.scylladb.com/manual/branch-2025.4/features/lwt.md)
- [How does ScyllaDB LWT Differ from Apache Cassandra?](https://docs.scylladb.com/manual/branch-2025.4/kb/lwt-differences.md)
...
For more details, see [the article on DESCRIBE SCHEMA](https://docs.scylladb.com/manual/branch-2025.4/cql/describe-schema.md).
