...
* [Hinted Handoff](https://docs.scylladb.com/manual/branch-2025.4/architecture/anti-entropy/hinted-handoff.md)
* [Read Repair](https://docs.scylladb.com/manual/branch-2025.4/architecture/anti-entropy/read-repair.md)
* [Repair Based Node Operations](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/procedures/cluster-management/repair-based-node-operation.md)
...
To synchronize all data in clusters that have both tablets- and vnodes-based keyspaces, run [nodetool repair -pr](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/nodetool-commands/repair.md) on **all**
of the nodes in the cluster, and [nodetool cluster repair](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/nodetool-commands/cluster/repair.md) on  **any** of the nodes in the cluster.

#### NOTE
Run the [nodetool repair](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/nodetool-commands/repair.md) and [nodetool cluster repair](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/nodetool-commands/cluster/repair.md) command regularly. If you delete data frequently, it should be more often than the value of `gc_grace_seconds` (by default: 10 days), for example, every week. Use the **nodetool repair -pr** on each node in the cluster, sequentially.
