...
1. Verify the node is up and has returned to the ScyllaDB cluster using [nodetool status](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/nodetool-commands/status.md).
