...
If this is not the case, one should use other restoration methods tools like [sstableloader](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/procedures/cassandra-to-scylla-migration-process.md). This procedure is much slower than restoring to the same topology cluster.
...
#### NOTE
If you are restoring [encrypted backup files](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/security/encryption-at-rest.md), make sure Scylla Enterprise has the same keys used by Scylla to encrypt the data before starting the restore process.

#### NOTE
Best practise is **not** to restore [Materialized Views (MV)](https://docs.scylladb.com/manual/branch-2025.4/features/materialized-views.md) and [Secondary Indexes (SI)](https://docs.scylladb.com/manual/branch-2025.4/features/secondary-indexes.md) SSTables.
...
1. Run the [nodetool drain](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/nodetool-commands/drain.md) command to ensure the data is flushed to the SSTables
