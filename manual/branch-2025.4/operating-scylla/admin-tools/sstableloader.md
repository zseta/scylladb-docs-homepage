...
Please consider switching to [nodetool refresh –load-and-stream](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/nodetool-commands/refresh.md).

#### NOTE
This tool is **different than Apache Cassandra’s sstableloader**, which uses an internal RPC protocol to load data.

#### NOTE
sstableloader does **not** support loading from encrypted files. For restoring data from encrypted files, see [Migration to ScyllaDB](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/procedures/cassandra-to-scylla-migration-process.md#cassandra-to-scylla-procedure).
...
See [Apache Cassandra to ScyllaDB Migration Process](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/procedures/cassandra-to-scylla-migration-process.md) for an example of usage.
