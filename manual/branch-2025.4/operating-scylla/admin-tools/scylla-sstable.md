...
For more information, see [Configuring Object Storage](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/admin.md#object-storage-configuration).
...
For more information about the sstable components and the format itself, visit [SSTable Format](https://docs.scylladb.com/manual/branch-2025.4/architecture/sstable/index.md).
...
Offline, scylla-sstable variant of [nodetool upgradesstables](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/nodetool-commands/upgradesstables.md).
...
It is strongly recommended to use the system schema tables as the schema source for this command, see the [schema options]()
