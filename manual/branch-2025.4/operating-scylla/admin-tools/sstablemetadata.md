...
#### WARNING
SSTableMetadata is deprecated since ScyllaDB 5.4, and will be removed in the next release.
Please consider switching to [dump-statistics](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/admin-tools/scylla-sstable.md#scylla-sstable-dump-statistics) and [dump-summary](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/admin-tools/scylla-sstable.md#scylla-sstable-dump-summary).
