...
Each role must already exist in Scylla, created via the [CREATE ROLE](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/security/authorization.md#create-role-statement) CQL command beforehand.
