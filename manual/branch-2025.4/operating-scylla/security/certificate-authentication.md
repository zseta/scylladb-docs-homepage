...
1. Enable authentication
   ...
   Enable authentication and define authorized roles in the cluster as described in the [Enable Authentication](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/security/authentication.md) document.
