...
- An automated install is included from [ScyllaDB Web Installer for Linux tool](https://docs.scylladb.com/manual/branch-2025.4/getting-started/installation-common/scylla-web-installer.md) (for the latest versions).
