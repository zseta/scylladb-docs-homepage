...
We recommend installing ScyllaDB using [ScyllaDB Web Installer for Linux](https://docs.scylladb.com/manual/branch-2025.4/getting-started/installation-common/scylla-web-installer.md),
...
* Ubuntu, Debian, CentOS, or RHEL (see [OS Support by Platform and Version](https://docs.scylladb.com/manual/branch-2025.4/getting-started/os-support.md)
  for details about supported versions and architecture)
* Root or `sudo` access to the system
* Open [ports used by ScyllaDB](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/security/security-checklist.md#networking-ports)
...
2. Run the `scylla_setup` script to tune the system settings and determine the optimal configuration.
   ...
   * The script invokes a set of [scripts](https://docs.scylladb.com/manual/branch-2025.4/getting-started/system-configuration.md#system-configuration-scripts) to configure several operating system settings; for example, it sets
   ...
   * The script runs a short (up to a few minutes) benchmark on your storage and generates the `/etc/scylla.d/io.conf`
     ...
     or `io.conf` file.
   * You can bypass this check by running ScyllaDB in [developer mode](https://docs.scylladb.com/manual/branch-2025.4/getting-started/installation-common/dev-mod.md).
