...
See [OS Support by Platform and Version](https://docs.scylladb.com/manual/branch-2025.4/getting-started/os-support.md) for information about
supported operating systems, distros, and versions.

See [Cloud Instance Recommendations for AWS, GCP, and Azure](https://docs.scylladb.com/manual/branch-2025.4/getting-started/cloud-instance-recommendations.md) for information
...
It’s recommended to have a balanced setup. If there are only 4-8 [Logical Cores](https://docs.scylladb.com/manual/branch-2025.4/reference/glossary.md#term-Logical-Core-lcore), large disks or 10Gbps networking may not be needed.
...
Use the default ICS unless you’ll have a clear understanding that another strategy is better for your use case. More on [choosing a Compaction Strategy](https://docs.scylladb.com/manual/branch-2025.4/architecture/compaction/compaction-strategies.md).
