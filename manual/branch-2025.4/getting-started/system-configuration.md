...
System configuration steps are performed automatically by the ScyllaDB RPM and deb packages. For information on getting started with ScyllaDB, see [Getting Started](https://docs.scylladb.com/manual/branch-2025.4/getting-started/index.md).
...
When installing ScyllaDB, it is highly recommended to use the [scylla_setup](https://docs.scylladb.com/manual/branch-2025.4/getting-started/system-configuration.md) script.
...
See [Seastar Perftune](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/admin-tools/perftune.md) for details.

## Configuring ScyllaDB

Configuration for ScyllaDB itself is in the [ScyllaDB Configuration](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/admin.md#admin-scylla-configuration) section of the administration guide.
