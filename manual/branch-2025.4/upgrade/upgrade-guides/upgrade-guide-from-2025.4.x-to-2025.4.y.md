# Upgrade - ScyllaDB 2025.4.x to 2025.4.y (Patch Upgrades)

This document describes a step-by-step procedure for upgrading from
ScyllaDB 2025.4.x  to ScyllaDB 2025.4.y (where “y” is
the latest available version), and rolling back to version 2025.4.x
if necessary.

This guide covers upgrading ScyllaDB on Red Hat Enterprise Linux (RHEL),
CentOS, Debian, and Ubuntu.
See [OS Support by Platform and Version](https://docs.scylladb.com/manual/branch-2025.4/getting-started/os-support.md)
...
* Not to use new 2025.4.y features.
...
2025.4.y to 2025.4.x. Apply this procedure if an upgrade from
2025.4.x to 2025.4.y failed before completing on all nodes.

* Use this procedure only on nodes you upgraded to 2025.4.y.
...
cluster shutdown. For each of the nodes to roll back to 2025.4.x, you will:
...
To downgrade to 2025.4.x on Debian or Ubuntu, run:

```console
sudo apt-get install scylla=2025.4.x\* scylla-server=2025.4.x\* scylla-tools=2025.4.x\* scylla-tools-core=2025.4.x\* scylla-kernel-conf=2025.4.x\* scylla-conf=2025.4.x\*
```
...
To downgrade to 2025.4.x on RHEL or CentOS, run:

```console
sudo yum downgrade scylla\*-2025.4.x-\* -y
```
...
```console
sudo apt-get install scylla=2025.4.x\* scylla-server=2025.4.x\* scylla-tools=2025.4.x\* scylla-tools-core=2025.4.x\* scylla-kernel-conf=2025.4.x\* scylla-conf=2025.4.x\*
sudo apt-get install scylla-machine-image=2025.4.x\*
```
