...
[Alternator-specific APIs](https://docs.scylladb.com/manual/branch-2025.4/alternator/new-apis.md). One of the options, `always_use_lwt`,
...
See [Workload Prioritization](https://docs.scylladb.com/manual/branch-2025.4/features/workload-prioritization.md)
...
in DynamoDB and Scylla - determined by the *sort key* defined for that table.
...
See [Enabling Experimental Features](https://docs.scylladb.com/manual/branch-2025.4/operating-scylla/admin.md#enabling-experimental-features) for details.
