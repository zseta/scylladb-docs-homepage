...
[Scylla Alternator for DynamoDB users](https://docs.scylladb.com/manual/branch-2025.4/alternator/compatibility.md) document.
...
As explained in [Scylla Alternator for DynamoDB users](https://docs.scylladb.com/manual/branch-2025.4/alternator/compatibility.md),
...
to be able to *discover* the Scylla nodes. Alternator provides two special
...
[Data Distribution with Tablets](https://docs.scylladb.com/manual/branch-2025.4/architecture/tablets.md) for details.
...
[tablets_mode_for_new_keyspaces](https://docs.scylladb.com/manual/branch-2025.4/reference/configuration-parameters.md#confval-tablets_mode_for_new_keyspaces)
tells them to.
