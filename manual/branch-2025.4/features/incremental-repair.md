...
The incremental_mode parameter can be specified using nodetool cluster repair, e.g., nodetool cluster repair –incremental-mode incremental. It can also be specified with the REST API, e.g., curl -X POST “[http://127.0.0.1:10000/storage_service/tablets/repair?ks=ks1&table=tb1&tokens=all&incremental_mode=incremental](http://127.0.0.1:10000/storage_service/tablets/repair?ks=ks1&table=tb1&tokens=all&incremental_mode=incremental)”
