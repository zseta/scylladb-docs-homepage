...
Apache Cassandra.  See [ScyllaDB Features](https://docs.scylladb.com/manual/branch-2026.1/features/index.md) for more information about ScyllaDB features.
...
|--------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|
| CQL                            | Fully compatible with version 3.3.1, with additional features from later CQL versions (for example, [Duration type](https://docs.scylladb.com/manual/branch-2026.1/cql/types.md#durations)).<br/><br/><br/>Fully compatible with protocol v4, with additional features from v5.<br/><br/> | More below                                                                                                                      |
...
* [Nodetool Reference](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/nodetool.md) - ScyllaDB commands for managing ScyllaDB node or cluster using the command-line nodetool utility.
* [CQLSh - the CQL shell](https://docs.scylladb.com/manual/branch-2026.1/cql/cqlsh.md).
* [Admin REST API - ScyllaDB Node Admin API](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/rest.md).
* [Tracing](https://docs.scylladb.com/manual/branch-2026.1/using-scylla/tracing.md) - a ScyllaDB tool for debugging and analyzing internal flows in the server.
* [SSTableloader](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin-tools/sstableloader.md) - Bulk load the sstables found in the directory to a ScyllaDB cluster
* [ScyllaDB SStable](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin-tools/scylla-sstable.md) - Validates and dumps the content of SStables, generates a histogram, dumps the content of the SStable index.
* [ScyllaDB Types](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin-tools/scylla-types.md) - Examines raw values obtained from SStables, logs, coredumps, etc.
* [cassandra-stress](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin-tools/cassandra-stress.md) A tool for benchmarking and load testing a ScyllaDB and Cassandra clusters.
* scylla local-file-key-generator - Generate a local file (system) key for [encryption at rest](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/security/encryption-at-rest.md), with the provided length, Key algorithm, Algorithm block mode and Algorithm padding method.
...
* [scylla_dev_mode_setup](https://docs.scylladb.com/manual/branch-2026.1/getting-started/installation-common/dev-mod.md) - run ScyllaDB in Developer Mode.
* [perftune](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin-tools/perftune.md) - performance configuration.
* [Reading mutation fragments](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin-tools/select-from-mutation-fragments.md) - dump the underlying mutation data from tables.
* [Maintenance socket](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin-tools/maintenance-socket.md) - a Unix domain socket for full-permission CQL connection.
* [Maintenance mode](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin-tools/maintenance-mode.md) - a mode for performing maintenance tasks on an offline ScyllaDB node.
* [Task manager](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin-tools/task-manager.md) - a tool for tracking long-running background operations.
...
<sub>\*</sub> See [ScyllaDB LWT](https://docs.scylladb.com/manual/branch-2026.1/features/lwt.md).

### Snitches

| Options                                                                                                                                                             | Support                                                    |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|
| [SimpleSnitch](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/system-configuration/snitch.md#snitch-simple-snitch)                                 | <i class="inline-icon icon-check" aria-hidden="true"></i>  |
| [RackInferringSnitch](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/system-configuration/snitch.md#snitch-rack-inferring-snitch)                  | <i class="inline-icon icon-check" aria-hidden="true"></i>  |
| PropertyFileSnitch                                                                                                                                                  | <i class="inline-icon icon-cancel" aria-hidden="true"></i> |
| [GossipingPropertyFileSnitch](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/system-configuration/snitch.md#snitch-gossiping-property-file-snitch) | <i class="inline-icon icon-check" aria-hidden="true"></i>  |
| Dynamic snitching                                                                                                                                                   | <i class="inline-icon icon-cancel" aria-hidden="true"></i> |
| [EC2Snitch](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/system-configuration/snitch.md#snitch-ec2-snitch)                                       | <i class="inline-icon icon-check" aria-hidden="true"></i>  |
| [EC2MultiRegionSnitch](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/system-configuration/snitch.md#snitch-ec2-multi-region-snitch)               | <i class="inline-icon icon-check" aria-hidden="true"></i>  |
| [GoogleCloudSnitch](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/system-configuration/snitch.md#googlecloudsnitch)                               | <i class="inline-icon icon-check" aria-hidden="true"></i>  |
| CloudstackSnitch                                                                                                                                                    | <i class="inline-icon icon-cancel" aria-hidden="true"></i> |
| [AzureSnitch](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/system-configuration/snitch.md#azuresnitch)                                           | <i class="inline-icon icon-check" aria-hidden="true"></i>  |
...
| Options                                                                                                                | Support                                                   |
|------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|
| [Encryption](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/security/client-node-encryption.md)       | <i class="inline-icon icon-check" aria-hidden="true"></i> |
| [Authentication](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/security/authentication.md)           | <i class="inline-icon icon-check" aria-hidden="true"></i> |
| [Compression](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin.md#admin-compression)  (see below) | <i class="inline-icon icon-check" aria-hidden="true"></i> |
...
| [Node to Node Compression](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin.md#internode-compression)           | <i class="inline-icon icon-check" aria-hidden="true"></i> |
| [Client to Node Compression](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin.md#admin-client-node-compression) | <i class="inline-icon icon-check" aria-hidden="true"></i> |

### Backup and Restore

| Options                                                                                                                                             | Support                                                   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|
| [Snapshot](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/procedures/backup-restore/backup.md#backup-full-backup-snapshots)        | <i class="inline-icon icon-check" aria-hidden="true"></i> |
| [Incremental backup](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/procedures/backup-restore/backup.md#backup-incremental-backup) | <i class="inline-icon icon-check" aria-hidden="true"></i> |
| [Restore](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/procedures/backup-restore/restore.md)                                     | <i class="inline-icon icon-check" aria-hidden="true"></i> |

### Repair and Consistency

| Options                                                                                                        | Support                                                    |
|----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|
| [Nodetool Repair](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/nodetool-commands/repair.md) | <i class="inline-icon icon-check" aria-hidden="true"></i>  |
| Incremental Repair                                                                                             | <i class="inline-icon icon-cancel" aria-hidden="true"></i> |
| [Hinted Handoff](https://docs.scylladb.com/manual/branch-2026.1/architecture/anti-entropy/hinted-handoff.md)   | <i class="inline-icon icon-check" aria-hidden="true"></i>  |
| [Lightweight Transactions](https://docs.scylladb.com/manual/branch-2026.1/features/lwt.md)                     | <i class="inline-icon icon-check" aria-hidden="true"></i>  |
...
| Options                                                                                             | Support                                                   |
|-----------------------------------------------------------------------------------------------------|-----------------------------------------------------------|
| [Secondary Index](https://docs.scylladb.com/manual/branch-2026.1/features/secondary-indexes.md)     | <i class="inline-icon icon-check" aria-hidden="true"></i> |
| [Materialized Views](https://docs.scylladb.com/manual/branch-2026.1/features/materialized-views.md) | <i class="inline-icon icon-check" aria-hidden="true"></i> |
...
| Feature                                                                                                      | Support                                                                      |
|--------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|
| [SizeTieredCompactionStrategy](https://docs.scylladb.com/manual/branch-2026.1/cql/compaction.md#stcs) (STCS) | <i class="inline-icon icon-check" aria-hidden="true"></i>                    |
| [LeveledCompactionStrategy](https://docs.scylladb.com/manual/branch-2026.1/cql/compaction.md#lcs) (LCS)      | <i class="inline-icon icon-check" aria-hidden="true"></i>                    |
| DateTieredCompactionStrategy (DTCS)                                                                          | <i class="inline-icon icon-cancel" aria-hidden="true"></i>     <sub>\*</sub> |
| [TimeWindowCompactionStrategy](https://docs.scylladb.com/manual/branch-2026.1/cql/compaction.md#twcs) (TWCS) | <i class="inline-icon icon-check" aria-hidden="true"></i>                    |
