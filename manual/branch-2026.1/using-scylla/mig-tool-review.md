...
* From SSTable to SSTable
  : - Using nodetool refresh, [Load and Stream](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/nodetool-commands/refresh.md#nodetool-refresh-load-and-stream) option.
