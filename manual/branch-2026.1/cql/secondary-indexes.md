...
where view_property is any [property](https://docs.scylladb.com/manual/branch-2026.1/cql/mv.md#mv-options) that can be used when creating
a [materialized view](https://docs.scylladb.com/manual/branch-2026.1/features/materialized-views.md). The only exception is CLUSTERING ORDER BY,
...
[Local Secondary Indexes](https://docs.scylladb.com/manual/branch-2026.1/features/local-secondary-indexes.md) is an enhancement of [Global Secondary Indexes](https://docs.scylladb.com/manual/branch-2026.1/features/secondary-indexes.md), which allows ScyllaDB to optimize the use case in which the partition key of the base table is also the partition key of the index. Local Secondary Index syntax is the same as above, with extra parentheses on the partition key.
...
More on [Local Secondary Indexes](https://docs.scylladb.com/manual/branch-2026.1/features/local-secondary-indexes.md)
