...
Refer to [LWT](https://docs.scylladb.com/manual/branch-2026.1/features/lwt.md) for more information.

The `gc_grace_seconds` parameter is defined [here](https://docs.scylladb.com/manual/branch-2026.1/cql/ddl.md#create-table-general-options).

## TTL for a Collection

You can set the TTL on a per element basis for collections. An example of how to do this, is shown in the [Maps](https://docs.scylladb.com/manual/branch-2026.1/cql/types.md#maps) CQL Reference.
...
* [KB Article:How to Change gc_grace_seconds for a Table](https://docs.scylladb.com/manual/branch-2026.1/kb/gc-grace-seconds.md)
* [KB Article:Time to Live (TTL) and Compaction](https://docs.scylladb.com/manual/branch-2026.1/kb/ttl-facts.md)
* [CQL Reference: Table Options](https://docs.scylladb.com/manual/branch-2026.1/cql/ddl.md#create-table-general-options)
