...
can also view the latest version of [cqlshrc online](https://github.com/scylladb/scylla-cqlsh/blob/master/conf/cqlshrc.sample).
...
If you want to display your current ScyllaDB version, refer to [Check your current version of ScyllaDB](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin.md#check-your-current-version-of-scylla).
...
See [a dedicated article](https://docs.scylladb.com/manual/branch-2026.1/cql/describe-schema.md) to learn more.
...
[Back](https://docs.scylladb.com/manual/branch-2026.1/getting-started/index.md)
