...
See [Enabling Experimental Features](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin.md#yaml-enabling-experimental-features) for details.
...
The `vector` is either the name of the float vector column or [vector of floats](https://docs.scylladb.com/manual/branch-2026.1/cql/types.md#vectors).
...
see [Counting all rows in a table is slow](https://docs.scylladb.com/manual/branch-2026.1/kb/count-all-rows.md) for instructions.
