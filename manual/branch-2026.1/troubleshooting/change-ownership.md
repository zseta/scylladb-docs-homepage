...
In cases where the ScyllaDB node fails to start, check ScyllaDB [logs](https://docs.scylladb.com/manual/branch-2026.1/getting-started/logging.md). If you see the following error message:
