...
2. Refer to [generate core dumps](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin.md#admin-core-dumps) for details.
...
* The contents of your tracing data. See [Collecting Tracing Data](https://docs.scylladb.com/manual/branch-2026.1/using-scylla/tracing.md#tracing-collecting-tracing-data).
