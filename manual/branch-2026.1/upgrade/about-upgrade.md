...
the [documented upgrade procedures](https://docs.scylladb.com/manual/branch-2026.1/upgrade/upgrade-guides/index.md) tested by
...
* You should follow the upgrade policy:
  ...
  >   See [ScyllaDB Version Support](https://docs.scylladb.com/stable/versioning/version-support.html).
