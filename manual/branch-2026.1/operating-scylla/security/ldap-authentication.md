...
The general instructions are [here](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/security/saslauthd.md).

1. Follow all of the steps in [this procedure](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/security/saslauthd.md) and use the code snippets below to list LDAP as the authentication mechanism.
