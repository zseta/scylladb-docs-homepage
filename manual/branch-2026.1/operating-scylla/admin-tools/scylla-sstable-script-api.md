...
* [ScyllaDB Consume API]()
  ...
  <a id="scylla-consume-api"></a>
   - Hook methods implemented by the script to consume a [mutation fragment stream](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin-tools/scylla-sstable.md#scylla-sstable-sstable-content);
* [ScyllaDB Lua API]()
...
The high-level API is for writing [mutation fragments](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin-tools/scylla-sstable.md#scylla-sstable-sstable-content) as JSON directly, using the built-in JSON conversion logic that is used by [dump-data](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin-tools/scylla-sstable.md#scylla-sstable-dump-data-operation) operation.
