...
To know which node hold the partition key use the nodetool [getendpoints](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/nodetool-commands/getendpoints.md) command.
...
* [Catching a Hot Partition](https://docs.scylladb.com/manual/branch-2026.1/using-scylla/tracing.md#tracing-catching-a-hot-partition) - Information on how to locate a hot partition
