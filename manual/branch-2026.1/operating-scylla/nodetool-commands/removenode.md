...
See [Remove a Node from a ScyllaDB Cluster](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/procedures/cluster-management/remove-node.md) for more information.
...
* Make sure that the number of nodes remaining in the DC after you remove a node
  ...
  [replace a dead node](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/procedures/cluster-management/replace-dead-node.md)
...
To only mark the node as permanently down without doing actual removal, use [nodetool excludenode](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/nodetool-commands/excludenode.md):
...
See [Task manager](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin-tools/task-manager.md).
