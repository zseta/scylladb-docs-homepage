...
See [Remove a Node from a ScyllaDB Cluster (Down Scale)](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/procedures/cluster-management/remove-node.md)
