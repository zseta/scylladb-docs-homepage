...
Make sure you have met the [System Requirements](https://docs.scylladb.com/manual/branch-2026.1/getting-started/system-requirements.md)  before you install and configure ScyllaDB.

## Download and Install

See the [getting started page](https://docs.scylladb.com/manual/branch-2026.1/getting-started/index.md) for info on installing ScyllaDB on your platform.

### System Configuration

See [System Configuration Guide](https://docs.scylladb.com/manual/branch-2026.1/getting-started/system-configuration.md#system-configuration-files-and-scripts) for details on optimum OS settings for ScyllaDB. (These settings are performed automatically in the ScyllaDB packages, Docker containers, and Amazon AMIs.)
...
This command allows you to check your current version of ScyllaDB. Note that this command is not the [nodetool version](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/nodetool-commands/version.md) command which reports the CQL version.
If you are looking for the CQL or Cassandra version, refer to the CQLSH reference for [SHOW VERSION](https://docs.scylladb.com/manual/branch-2026.1/cql/cqlsh.md#cqlsh-show-version).
...
| replace_node_first_boot | Host ID of a dead node this ScyllaDB node is replacing. Refer to [Replace a Dead Node in a ScyllaDB Cluster](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/procedures/cluster-management/replace-dead-node.md) for more details. |
...
To read the rest of the [Administration Guide](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin.md) (from the top).

To go to the System Configuration documentation, click [here](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/system-configuration/index.md).
...
ScyllaDB supports encryption between nodes and between client and node. See the ScyllaDB [ScyllaDB TLS/SSL guide:](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/security/index.md) for configuration settings.
...
are open. See [ScyllaDB Alternator](https://docs.scylladb.com/manual/branch-2026.1/alternator/alternator.md) for details.
...
#### NOTE
For tips and examples on how to configure these addresses, refer to [How to Properly Set Address Values in scylla.yaml](https://docs.scylladb.com/manual/branch-2026.1/kb/yaml-address.md)
...
ScyllaDB places any core dumps in `var/lib/scylla/coredump`. They are not visible with the `coredumpctl` command. See the [System Configuration Guide](https://docs.scylladb.com/manual/branch-2026.1/getting-started/system-configuration.md) for details on core dump configuration scripts. Check with ScyllaDB support before sharing any core dump, as they may contain sensitive data.
...
only when the keyspaces are [RF-rack-valid](https://docs.scylladb.com/manual/branch-2026.1/reference/glossary.md#term-RF-rack-valid-keyspace).
...
The [nodetool](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/nodetool.md) CLI tool uses the REST API
