...
An arbiter DC is a datacenter with a [zero-token node](https://docs.scylladb.com/manual/branch-2026.1/architecture/zero-token-nodes.md)
...
[add a new datacenter to an existing cluster](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/procedures/cluster-management/add-dc-to-existing-dc.md).
...
* Set `join_ring=false` before you start the node(s). If you set that
  ...
  [decommission](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/procedures/cluster-management/decommissioning-data-center.md)
  the node, [wipe it clean](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/procedures/cluster-management/clear-data.md),
  and add it back to the arbiter DC properly following
  the [procedure](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/procedures/cluster-management/add-dc-to-existing-dc.md).
...
* Since zero-token nodes are ignored by drivers, you can skip
  [configuring the client not to connect to the new DC](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/procedures/cluster-management/add-dc-to-existing-dc.md#add-dc-to-existing-dc-not-connect-clients).

## References

* [Zero-token Nodes](https://docs.scylladb.com/manual/branch-2026.1/architecture/zero-token-nodes.md)
* [Raft Consensus Algorithm in ScyllaDB](https://docs.scylladb.com/manual/branch-2026.1/architecture/raft.md)
* [Handling Node Failures](https://docs.scylladb.com/manual/branch-2026.1/troubleshooting/handling-node-failures.md)
* [Adding a New Data Center Into an Existing ScyllaDB Cluster](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/procedures/cluster-management/add-dc-to-existing-dc.md)
