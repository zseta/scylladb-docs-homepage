...
**Note** - Switching a snitch requires a full cluster shutdown, so It is highly recommended to choose the [right snitch](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/system-configuration/snitch.md) for your needs at the cluster setup phase.

For example:

Original cluster: three nodes cluster on a single data-center with [Simplesnitch](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/system-configuration/snitch.md#snitch-simple-snitch) or [Ec2snitch](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/system-configuration/snitch.md#snitch-ec2-snitch).

Change to: three nodes in one data-center and one rack using a [GossipingPropertyFileSnitch](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/system-configuration/snitch.md#snitch-gossiping-property-file-snitch) or [Ec2multiregionsnitch](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/system-configuration/snitch.md#snitch-ec2-multi-region-snitch).
