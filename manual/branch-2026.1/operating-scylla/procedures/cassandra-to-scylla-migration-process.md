...
#### NOTE
Scylla and Apache Cassandra [encrypted backup files](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/security/encryption-at-rest.md) are **not** compatible.
...
* Update the SSTables files with [upgradesstable](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/nodetool-commands/upgradesstables.md)
* Use sstableloader
...
#### NOTE
ScyllaDB supports [Materialized View(MV)](https://docs.scylladb.com/manual/branch-2026.1/features/materialized-views.md) and [Secondary Index(SI)](https://docs.scylladb.com/manual/branch-2026.1/features/secondary-indexes.md).
...
* Upload all the data with sstableloader first, and only then [create the secondary indexes](https://docs.scylladb.com/manual/branch-2026.1/cql/secondary-indexes.md#create-index-statement) and [MVs](https://docs.scylladb.com/manual/branch-2026.1/cql/mv.md#create-materialized-view-statement).
...
More on [ScyllaDB and Apache Cassandra Compatibility](https://docs.scylladb.com/manual/branch-2026.1/using-scylla/cassandra-compatibility.md)
