...
[ScyllaDB Alternator for DynamoDB users](https://docs.scylladb.com/manual/branch-2026.1/alternator/compatibility.md) document.
...
As explained in [ScyllaDB Alternator for DynamoDB users](https://docs.scylladb.com/manual/branch-2026.1/alternator/compatibility.md),
...
to be able to *discover* the ScyllaDB nodes. Alternator provides two special
...
This request is called “localnodes” because it returns the *local* nodes -
...
list the nodes in a specific *data center* or *rack*. These options are
...
* A `dc` option (e.g., `/localnodes?dc=dc1`) can be passed to list the
  ...
  being contacted. This is useful when a client knowns of *some* Scylla
  node belonging to an unknown DC, but wants to list the nodes in *its*
...
[Data Distribution with Tablets](https://docs.scylladb.com/manual/branch-2026.1/architecture/tablets.md) for details.
...
[tablets_mode_for_new_keyspaces](https://docs.scylladb.com/manual/branch-2026.1/reference/configuration-parameters.md#confval-tablets_mode_for_new_keyspaces)
tells them to.
