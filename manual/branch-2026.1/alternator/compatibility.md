...
[Alternator-specific APIs](https://docs.scylladb.com/manual/branch-2026.1/alternator/new-apis.md). One of the options, `always_use_lwt`,
...
See [Workload Prioritization](https://docs.scylladb.com/manual/branch-2026.1/features/workload-prioritization.md)
...
See [Enabling Experimental Features](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/admin.md#enabling-experimental-features) for details.
...
* The DynamoDB Streams API for capturing change is supported, but still
  ...
  See [https://github.com/scylladb/scylla/issues/23838](https://github.com/scylladb/scylla/issues/23838).
  ...
  * The optional ShardFilter parameter to DescribeStream, added to DynamoDB
    ...
    Alternator.
    [https://github.com/scylladb/scylla/issues/25160](https://github.com/scylladb/scylla/issues/25160)
