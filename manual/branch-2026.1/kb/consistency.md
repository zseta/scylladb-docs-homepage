...
specify a Consistency Level per query is known as [Tunable Consistency](https://docs.scylladb.com/manual/branch-2026.1/reference/glossary.md#term-Tunable-Consistency).
...
A related feature is [Lightweight Transactions (LWT)](https://docs.scylladb.com/manual/branch-2026.1/features/lwt.md). LWT in ScyllaDB allow the client
...
* [Consistency Levels documentation](https://docs.scylladb.com/manual/branch-2026.1/cql/consistency.md)
