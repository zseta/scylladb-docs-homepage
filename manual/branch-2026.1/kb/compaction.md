...
* Minor Compaction
  : ScyllaDB automatically triggers a compaction of some SSTables, according to a [compaction strategy](https://docs.scylladb.com/manual/branch-2026.1/reference/glossary.md#term-Compaction-Strategy) (as described below). This is the recommended method.
* Major Compaction
...
Compaction strategies are set as part of the `CREATE` or `ALTER` statement when creating or altering tables. Refer to the [CQL syntax](https://docs.scylladb.com/manual/branch-2026.1/cql/compaction.md) for details.
...
An SSTable is added to an existing bucket if size of the SSTable is within the parameters: [bucket_low](https://docs.scylladb.com/manual/branch-2026.1/cql/compaction.md#stcs-options) and [bucket_high](https://docs.scylladb.com/manual/branch-2026.1/cql/compaction.md#stcs-options), which is based on calculating the current average size of the SSTables already in the bucket.
...
1. A time window is configured. The window is determined by the compaction window size [compaction_window_size](https://docs.scylladb.com/manual/branch-2026.1/cql/compaction.md#twcs-options)  and the time unit ([compaction_window_unit](https://docs.scylladb.com/manual/branch-2026.1/cql/compaction.md#twcs-options)).
...
Use the table in [Which strategy is best](https://docs.scylladb.com/manual/branch-2026.1/architecture/compaction/compaction-strategies.md#which-strategy-is-best) to determine the right strategy for your needs.

## References

* [CQL Reference for Compaction](https://docs.scylladb.com/manual/branch-2026.1/cql/compaction.md)
* [How to Choose a Compaction Strategy](https://docs.scylladb.com/manual/branch-2026.1/architecture/compaction/compaction-strategies.md).
