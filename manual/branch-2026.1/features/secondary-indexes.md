...
For this reason, secondary indexes in ScyllaDB are **global** rather than local. With global indexing, a materialized view is created for each index. This [materialized view](https://docs.scylladb.com/manual/branch-2026.1/features/materialized-views.md) has the indexed column as a partition key and primary key (partition key and clustering keys) of the indexed row as clustering keys.
...
The following is an example and does not contain all of the options available. To see all of the options available, refer to the [CQL Reference](https://docs.scylladb.com/manual/branch-2026.1/cql/secondary-indexes.md).
...
* [CQL Reference](https://docs.scylladb.com/manual/branch-2026.1/cql/secondary-indexes.md) - CQL Reference for Secondary Indexes
