...
As explained in [CDC Stream Changes](https://docs.scylladb.com/manual/branch-2026.1/features/cdc/cdc-stream-changes.md), the set of used CDC stream IDs may change due to some events. You should then query the CDC description table to read the new set of stream IDs and the corresponding timestamp.
...
- [Vnode-based keyspaces](#vnode-based-keyspaces)
- [Tablets-based keyspaces](#tablets-based-keyspaces)
...
<a id="tablets-based-keyspaces"></a>
