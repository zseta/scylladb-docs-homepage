...
* in a vnode-based keyspace, the currently operating *CDC generation* ([CDC Stream Changes](https://docs.scylladb.com/manual/branch-2026.1/features/cdc/cdc-stream-changes.md)),
