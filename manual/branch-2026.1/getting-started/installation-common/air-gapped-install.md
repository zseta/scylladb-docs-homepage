...
- Without root privileges: using the [ScyllaDB Unified Installer](https://docs.scylladb.com/manual/branch-2026.1/getting-started/installation-common/unified-installer.md).
