...
1. Choose an instance type. See [Cloud Instance Recommendations for Azure](https://docs.scylladb.com/manual/branch-2026.1/getting-started/cloud-instance-recommendations.md#system-requirements-azure) for the list of recommended instances.
...
5. See the following table to obtain image information for the latest patch release.
   For earlier releases, see [Azure Images](https://docs.scylladb.com/manual/branch-2026.1/reference/azure-images.md)
   <!-- -*- mode: rst -*- -->
   ...
   |----------------------------|-------------------------|-----------------------------------------------|
   | scylla-2026.1              | 2026.1.13               | scylladb-7e8d8a04-23db-487d-87ec-0e175c0615bb |
