...
1. Choose an instance type. See [Cloud Instance Recommendations for GCP](https://docs.scylladb.com/manual/branch-2026.1/getting-started/cloud-instance-recommendations.md#system-requirements-gcp) for the list of recommended instances.
...
2. See the following table to obtain image information for the latest patch release.
   For earlier releases, see [GCP Images](https://docs.scylladb.com/manual/branch-2026.1/reference/gcp-images.md)
   <!-- -*- mode: rst -*- -->
...
4. (Optional) Configure firewall rules.
   ...
   Ensure that all [ScyllaDB ports](https://docs.scylladb.com/manual/branch-2026.1/operating-scylla/security/security-checklist.md#networking-ports) are open.
