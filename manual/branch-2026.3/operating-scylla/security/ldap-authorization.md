...
Each role must already exist in Scylla, created via the [CREATE ROLE](https://docs.scylladb.com/manual/stable/operating-scylla/security/authorization.md#create-role-statement) CQL command beforehand.
