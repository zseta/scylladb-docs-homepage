...
**Step 3**: Drop the quarantined SSTables using [dropquarantinedsstables](https://docs.scylladb.com/manual/stable/operating-scylla/nodetool-commands/dropquarantinedsstables.md):
