...
Tables using Incremental Repair can schedule repairs in ScyllaDB itself, with [Automatic Repair](https://docs.scylladb.com/manual/stable/features/automatic-repair.md).
