...
the following [ports](https://docs.scylladb.com/manual/stable/operating-scylla/admin.md#cqlsh-networking).
...
[Knowledge Base](https://docs.scylladb.com/manual/stable/kb/index.md)
