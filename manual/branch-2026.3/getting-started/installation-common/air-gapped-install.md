...
- Without root privileges: using the [ScyllaDB Unified Installer](https://docs.scylladb.com/manual/stable/getting-started/installation-common/unified-installer.md).
