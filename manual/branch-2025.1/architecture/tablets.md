...
[keyspaces created with tablets enabled](https://docs.scylladb.com/manual/branch-2025.1/cql/ddl.md#tablets).
...
controlled by the [`tablets_mode_for_new_keyspaces`](https://docs.scylladb.com/manual/branch-2025.1/reference/configuration-parameters.md#confval-tablets_mode_for_new_keyspaces) option. However, tablets only work if
...
unless the [`tablets_mode_for_new_keyspaces`](https://docs.scylladb.com/manual/branch-2025.1/reference/configuration-parameters.md#confval-tablets_mode_for_new_keyspaces) option is set to `enforced`.
...
#### WARNING
If a keyspace has tablets enabled, it must remain [RF-rack-valid](https://docs.scylladb.com/manual/branch-2025.1/reference/glossary.md#term-RF-rack-valid-keyspace)
...
See [Views with tablets](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/admin.md#admin-views-with-tablets) for details.
