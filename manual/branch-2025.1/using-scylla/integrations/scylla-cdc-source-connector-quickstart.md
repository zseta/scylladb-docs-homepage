...
a ScyllaDB table using [ScyllaDB CDC](https://docs.scylladb.com/manual/branch-2025.1/features/cdc/cdc-intro.md).
...
environments, please refer to the [Getting Started guide](https://docs.scylladb.com/manual/branch-2025.1/getting-started/index.md).
...
To learn more about ScyllaDB CDC, visit [Change Data Capture (CDC) page](https://docs.scylladb.com/manual/branch-2025.1/features/cdc/index.md).
