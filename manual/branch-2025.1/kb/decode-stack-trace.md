...
1. Copy the stack from the [system log](https://docs.scylladb.com/manual/branch-2025.1/getting-started/logging.md) and place it in a file (trace.txt, for example).
   ```none
