...
When you create a snapshot using [nodetool snapshot](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/nodetool-commands/snapshot.md) command, ScyllaDB is not going to copy existing SStables to the snapshot directory as one could have expected. Instead, it is going to create hard links to them. While this may seem trivial, what should be noted is the following:
...
* [Nodetool Snapshoot](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/nodetool-commands/snapshot.md)
