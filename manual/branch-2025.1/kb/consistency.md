...
This is also related to the [CAP theorem](https://en.wikipedia.org/wiki/CAP_theorem), which states that in a distributed data system,
...
specify a Consistency Level per query is known as [Tunable Consistency](https://docs.scylladb.com/manual/branch-2025.1/reference/glossary.md#term-Tunable-Consistency).
...
A related feature is [Lightweight Transactions (LWT)](https://docs.scylladb.com/manual/branch-2025.1/features/lwt.md). LWT in ScyllaDB allow the client
...
* [Consistency Levels documentation](https://docs.scylladb.com/manual/branch-2025.1/cql/consistency.md)
