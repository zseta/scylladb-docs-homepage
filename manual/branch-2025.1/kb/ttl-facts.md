...
It is not always clear under which circumstances data is deleted when using Time to Live (TTL) and [gc_grace_seconds](https://docs.scylladb.com/manual/branch-2025.1/cql/ddl.md#gc-grace-seconds) arguments in table definitions.
...
* [How to Change gc_grace_seconds for a Table](https://docs.scylladb.com/manual/branch-2025.1/kb/gc-grace-seconds.md)
