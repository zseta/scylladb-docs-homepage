...
This document describes the compaction strategy options available when creating a table. For more information about creating a table in ScyllaDB, refer to the [CQL Reference](https://docs.scylladb.com/manual/branch-2025.1/cql/ddl.md#create-table-statement).
...
: Selects the compaction strategy.
  <br/>
  It can be one of the following. If you are unsure which one to choose, refer to [Compaction Strategies](https://docs.scylladb.com/manual/branch-2025.1/architecture/compaction/compaction-strategies.md) :
  <br/>
...
* [Compaction Strategies](https://docs.scylladb.com/manual/branch-2025.1/architecture/compaction/compaction-strategies.md)
* [Compaction Overview](https://docs.scylladb.com/manual/branch-2025.1/kb/compaction.md)
