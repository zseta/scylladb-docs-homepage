...
After [enabling object storage support](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/admin.md#admin-keyspace-storage-options), configure your endpoints by
following these [instructions](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/admin.md#object-storage-configuration).
...
For more details, see [the article on DESCRIBE SCHEMA](https://docs.scylladb.com/manual/branch-2025.1/cql/describe-schema.md).
