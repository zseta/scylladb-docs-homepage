...
and most are reserved. The list of those keywords can be found in [Appendix A: CQL Keywords](https://docs.scylladb.com/manual/branch-2025.1/cql/appendices.md#appendix-a).
...
For how these constants are typed, see the [data-types](https://docs.scylladb.com/manual/branch-2025.1/cql/types.md) document.
...
- A literal for either [a collection](https://docs.scylladb.com/manual/branch-2025.1/cql/types.md#collections), a user-defined type or a tuple
...
- [Data Definition](https://docs.scylladb.com/manual/branch-2025.1/cql/ddl.md) statements - to define and change how the data is stored (keyspaces and tables).
- [Data Manipulation](https://docs.scylladb.com/manual/branch-2025.1/cql/dml.md) statements - for selecting, inserting and deleting data.
- [Permissions](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/security/authorization.md#cql-permissions) statements.
...
[Apache Cassandra Query Language](https://docs.scylladb.com/manual/branch-2025.1/cql/index.md)
