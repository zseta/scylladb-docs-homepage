...
* The recommended instance types are [i3en](#system-requirements-i3en-instances), and [i4i](#system-requirements-i4i-instances).
...
Recommended instances types are [z3-highmem-highlssd](https://cloud.google.com/compute/docs/storage-optimized-machines#z3_machine_types),
