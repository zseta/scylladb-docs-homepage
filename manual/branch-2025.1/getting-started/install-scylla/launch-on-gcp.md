...
1. Choose an instance type. See [Cloud Instance Recommendations for GCP](https://docs.scylladb.com/manual/branch-2025.1/getting-started/cloud-instance-recommendations.md#system-requirements-gcp) for the list of recommended instances.
...
4. (Optional) Configure firewall rules.
   ...
   Ensure that all [ScyllaDB ports](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/security/security-checklist.md#networking-ports) are open.
