...
4. If you want to create users and roles, continue to [Enable Authorization](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/security/enable-authorization.md).
