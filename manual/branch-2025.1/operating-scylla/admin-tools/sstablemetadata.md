...
Please consider switching to [dump-statistics](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/admin-tools/scylla-sstable.md#scylla-sstable-dump-statistics) and [dump-summary](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/admin-tools/scylla-sstable.md#scylla-sstable-dump-summary).
