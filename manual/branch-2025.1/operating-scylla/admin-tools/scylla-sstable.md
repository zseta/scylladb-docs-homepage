...
For more information about the sstable components and the format itself, visit [SSTable Format](https://docs.scylladb.com/manual/branch-2025.1/architecture/sstable/index.md).
