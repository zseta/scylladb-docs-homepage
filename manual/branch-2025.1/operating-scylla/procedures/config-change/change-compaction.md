...
1. Change the compaction strategy to a new one. If you are unsure of which strategy to use, refer to [Choose a Compaction Strategy](https://docs.scylladb.com/manual/branch-2025.1/architecture/compaction/compaction-strategies.md#which-strategy-is-best) for more information.
