...
1. Add [new bigger nodes](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/procedures/cluster-management/add-node-to-cluster.md)  to the cluster. Confirm Streaming has completed before continuing.
2. [Remove the old smaller nodes](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/procedures/cluster-management/remove-node.md). Confirm Streaming has completed before continuing.
...
1. Run [nodetool drain](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/nodetool-commands/drain.md) to stop traffic to the node.
2. Stop the service.
