...
**Procedure to Use** - [Add a New Node Into an Existing ScyllaDB Cluster](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/procedures/cluster-management/add-node-to-cluster.md)
...
**Procedure to Use** - [Remove a Node from a ScyllaDB Cluster (Down Scale)](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/procedures/cluster-management/remove-node.md)
...
**Procedure to Use** - [Replace a Dead Node in a ScyllaDB Cluster](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/procedures/cluster-management/replace-dead-node.md)
