...
You can set the ttl using [nodetool tasks user-ttl](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/nodetool-commands/tasks/user-ttl.md).
...
* `--endpoint` - Name of the configured object storage endpoint to copy SSTables to.
  This should be configured as per [the object storage configuration instructions](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/admin.md#object-storage-configuration).
...
[Nodetool restore](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/nodetool-commands/restore.md)
