...
See [Remove a Node from a ScyllaDB Cluster](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/procedures/cluster-management/remove-node.md) for more information.
...
* Make sure that the number of nodes remaining in the DC after you remove a node
  ...
  [replace a dead node](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/procedures/cluster-management/replace-dead-node.md)
