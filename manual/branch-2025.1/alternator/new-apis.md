...
[Scylla Alternator for DynamoDB users](https://docs.scylladb.com/manual/branch-2025.1/alternator/compatibility.md) document.
...
As explained in [Scylla Alternator for DynamoDB users](https://docs.scylladb.com/manual/branch-2025.1/alternator/compatibility.md),
...
* The table must have one of the write isolation modes which does not
  ...
  See [https://github.com/scylladb/scylladb/issues/18068](https://github.com/scylladb/scylladb/issues/18068).
* Enabling TTL with UpdateTableToLive doesn’t work (results in an error).
  See [https://github.com/scylladb/scylla/issues/16567](https://github.com/scylladb/scylla/issues/16567).
* Enabling Streams with CreateTable or UpdateTable doesn’t work
  (results in an error).
  See [https://github.com/scylladb/scylla/issues/16317](https://github.com/scylladb/scylla/issues/16317).
