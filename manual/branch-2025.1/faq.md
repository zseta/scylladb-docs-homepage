...
Swap can be set up in several ways. One way to set up swap is detailed in the KB Article [How to Set up a Swap Space](https://docs.scylladb.com/manual/branch-2025.1/kb/set-up-swap.md).

### My query does not return any or some of the data? What happened?

If you are using a time range in the query, refer to the solution in the troubleshooting document, [Time Range Queries Do Not Return Some or All of the Data](https://docs.scylladb.com/manual/branch-2025.1/troubleshooting/time-zone.md).
...
As SI is built on top of MV, you can expect to see MV in your schema. There is nothing wrong with your system. More information on [Global Secondary Indexes](https://docs.scylladb.com/manual/branch-2025.1/features/secondary-indexes.md).
...
You can clean snapshots by using [nodetool clearsnapshot](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/nodetool-commands/clearsnapshot.md). Read more on [snapshot and clearsnapshot](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/procedures/backup-restore/delete-snapshot.md)
...
Check the [Operating System Support Guide](https://docs.scylladb.com/manual/branch-2025.1/getting-started/os-support.md) for a list of supported operating systems and versions.
...
The [new “mc” SSTable format](https://docs.scylladb.com/manual/branch-2025.1/architecture/sstable/sstable3/index.md) is supported in ScyllaDB 3.0 and later.
...
A description of all snitch options we support may be found in [Snitches](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/system-configuration/snitch.md).
...
- [Alter](https://docs.scylladb.com/manual/branch-2025.1/cql/ddl.md#alter-keyspace-statement) the replication factor for desired keyspace (using cqlsh for instance).
...
- If you’re increasing the replication factor, refer to [How to Safely Increase the RF](https://docs.scylladb.com/manual/branch-2025.1/kb/rf-increase.md)
...
You can, but it is not recommended. ScyllaDB [clustering architecture](https://docs.scylladb.com/manual/branch-2025.1/architecture/ringarchitecture/index.md) already provides data replication across nodes and DCs.
...
Increase the Replication Factor (RF) of [relevant Keyspaces](https://docs.scylladb.com/manual/branch-2025.1/cql/ddl.md).

### Can I use JBOD and not use RAID0?

[JBOD](https://docs.scylladb.com/manual/branch-2025.1/reference/glossary.md#term-JBOD) is not supported by ScyllaDB.
...
When running [nodetool repair](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/nodetool-commands/repair.md) on a node, it performs a repair on every token range this node owns; this will also repair other nodes that share the same range.
...
or added to your `scylla.yaml` (see [ScyllaDB Configuration](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/admin.md)).
