...
* it is easy to learn what the used stream IDs are ([Querying CDC Streams](https://docs.scylladb.com/manual/branch-2025.1/features/cdc/cdc-querying-streams.md)).
