...
2. then consult the [Basic operations in CDC](https://docs.scylladb.com/manual/branch-2025.1/features/cdc/cdc-basic-operations.md) document to understand how basic modification statements, such as single UPDATEs or DELETEs, which don’t involve collections, are reflected in CDC using delta rows.
...
If you want to use CDC efficiently, it’s important to understand how stream IDs are managed and chosen. Consult the [CDC Streams](https://docs.scylladb.com/manual/branch-2025.1/features/cdc/cdc-streams.md) document for basic definitions and properties, [CDC Stream Generations](https://docs.scylladb.com/manual/branch-2025.1/features/cdc/cdc-stream-generations.md) document to understand how streams are managed and how they change over time, and finally [Querying CDC Streams](https://docs.scylladb.com/manual/branch-2025.1/features/cdc/cdc-querying-streams.md) to learn how streams can be queried efficiently, and how to find out which streams to query. Reading these documents is not a prerequisite for understanding the rest of the log table related sections.
...
Values 1-8 are for delta rows. Read about the different operations in the [Basic operations in CDC](https://docs.scylladb.com/manual/branch-2025.1/features/cdc/cdc-basic-operations.md) document.
