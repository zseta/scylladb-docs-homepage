...
As explained in [CDC Stream Generations](https://docs.scylladb.com/manual/branch-2025.1/features/cdc/cdc-stream-generations.md), the set of used CDC stream IDs changes whenever you bootstrap a new node. You should then query the CDC description table to read the new set of stream IDs and the corresponding timestamp.
