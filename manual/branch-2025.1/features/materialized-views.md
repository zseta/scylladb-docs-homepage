...
See the [CQL Reference for Materialized Views](https://docs.scylladb.com/manual/branch-2025.1/cql/mv.md) for more examples.

## Compaction Strategies with Materialized Views

Materialized views, just like regular tables, use one of the available [compaction strategies](https://docs.scylladb.com/manual/branch-2025.1/architecture/compaction/compaction-strategies.md).
...
* [CQL Reference for Materialized Views](https://docs.scylladb.com/manual/branch-2025.1/cql/mv.md)
