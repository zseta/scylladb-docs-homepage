...
When there is an unknown problem, checking the [logs](https://docs.scylladb.com/manual/branch-2025.1/getting-started/logging.md) is mandatory, using `journalctl -xe`
...
2. Run the [nodetool repair](https://docs.scylladb.com/manual/branch-2025.1/operating-scylla/nodetool-commands/repair.md) command on the node with the corrupted SSTable
